package com.jlpay.quickpass.srv.trans.service.impl;
...
public class Test {
    ...
    public static final String EUREKA_URL = "http://127.0.0.1:7000/eureka/";

    public void test(String serviceId, String mothed, String uri) {
        EurekaClientConfigBean bean = new EurekaClientConfigBean();
        Map<String, String> map = new HashMap<String, String>();
        //eureka服务注册中心地址
        map.put(EurekaClientConfigBean.DEFAULT_ZONE, EUREKA_URL);
...
//        okHttpLoadBalancingClient.setLoadBalancer(loadBalancer);
        ...
        RibbonCommandContext context = new RibbonCommandContext(serviceId, mothed, uri, Boolean.FALSE, new HttpHeaders(),
